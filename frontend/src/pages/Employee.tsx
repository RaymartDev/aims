...
import DeleteConfirmation from "@/modals/DeleteConfirmation"; // Import DeleteConfirmation modal
...
function Employee() {
  ...
  const registerEmployee = (id: number) => {
    setEmployees((prevEmployees) =>
      prevEmployees.map((employee) =>
        employee.id === id ? { ...employee, registered_status: true } : employee
      )
    );
    setRegEmployee(null);
  };
  ...
  return (
    <>
          ...
          <div className="flex justify-center mt-10">
            <div className="flex flex-row justify-between w-full">
              ...
              <div className="flex flex-row w-6/12 space-x-2">
                ...
                <Button
                  className="bg-hoverCream text-fontHeading border hover:text-white font-semibold w-40"
                    ...
                    <TableCell align="center">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setOpenDeleteModal(true); // Open delete modal on Trash click
                        }}
                      >
                        <Trash />
                      </Button>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                          ...
                          <DropdownMenuItem
                            disabled={employee.registered_status}
                            onClick={() => {
      ...
      <DeleteConfirmation open={openDeleteModal} onClose={() => setOpenDeleteModal(false)} onDelete={() => {
