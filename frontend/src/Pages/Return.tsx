  ...
  const itemList = [
    { id: 1, itemNumber: "215424", itemDesc: "HP Probook 8GB RAM / 512GB SSD", quantity: 2, unit: "PC", serialNumber: "1234", remarks: "N/A" },
    { id: 2, itemNumber: "215425", itemDesc: "ASUS ROG 16GB RAM / 1TB SSD", quantity: 3, unit: "PC", serialNumber: "5678", remarks: "New" },
    { id: 3, itemNumber: "215426", itemDesc: "Dell XPS 13 8GB RAM / 256GB SSD", quantity: 1, unit: "PC", serialNumber: "9101", remarks: "Refurbished" },
    { id: 4, itemNumber: "215427", itemDesc: "Lenovo ThinkPad 16GB RAM / 512GB SSD", quantity: 4, unit: "PC", serialNumber: "1121", remarks: "In Use" },
    { id: 5, itemNumber: "215428", itemDesc: "Apple MacBook Pro 16GB RAM / 512GB SSD", quantity: 2, unit: "PC", serialNumber: "3141", remarks: "Damaged" },
    { id: 6, itemNumber: "215429", itemDesc: "HP EliteBook 8GB RAM / 1TB SSD", quantity: 1, unit: "PC", serialNumber: "5161", remarks: "Under Repair" },
    { id: 7, itemNumber: "215430", itemDesc: "Microsoft Surface Pro 4GB RAM / 128GB SSD", quantity: 3, unit: "PC", serialNumber: "7181", remarks: "Returned" },
    { id: 8, itemNumber: "215431", itemDesc: "Acer Aspire 8GB RAM / 256GB SSD", quantity: 5, unit: "PC", serialNumber: "9202", remarks: "New" },
    { id: 9, itemNumber: "215432", itemDesc: "Samsung Galaxy Book 12GB RAM / 512GB SSD", quantity: 1, unit: "PC", serialNumber: "1232", remarks: "N/A" },
    { id: 10, itemNumber: "215433", itemDesc: "Razer Blade 16GB RAM / 1TB SSD", quantity: 2, unit: "PC", serialNumber: "3243", remarks: "Used" },
    { id: 11, itemNumber: "215434", itemDesc: "MSI GF63 8GB RAM / 512GB SSD", quantity: 2, unit: "PC", serialNumber: "4254", remarks: "New" },
    { id: 12, itemNumber: "215435", itemDesc: "HP Pavilion 8GB RAM / 1TB SSD", quantity: 1, unit: "PC", serialNumber: "5265", remarks: "In Use" },
    { id: 13, itemNumber: "215436", itemDesc: "Toshiba Tecra 4GB RAM / 256GB SSD", quantity: 4, unit: "PC", serialNumber: "6276", remarks: "Returned" },
    { id: 14, itemNumber: "215437", itemDesc: "Sony Vaio 8GB RAM / 512GB SSD", quantity: 1, unit: "PC", serialNumber: "7287", remarks: "Refurbished" },
  ...
  function AcknowledgementReceipt() {
    ...
    const handleQuantityChange = (id: number, value: string, maxQuantity: number) => {
                          ...
                          <TableRow className="h-8" key={itemList.id}>
                              ...
                              <TableCell>
                                <Input
                                  ...
                                  onChange={(e) => handleQuantityChange(itemList.id, e.target.value, itemList.quantity)}
                                />
                              </TableCell>
