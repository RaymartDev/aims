...
interface AddMaterialModal2Props {
    open: boolean;
    onClose: () => void;
    onBack: () => void;
}
            ...
            <div className="flex flex-col w-1/3 bg-slate-50 rounded-2xl p-6">
                ...
                <div className="flex flex-col justify-start mt-5 space-y-2">
                    <div className="space-y-1">
                        <p className="text-sm text-[#697386]">Additional Description</p>
                    ...
                    <div className="space-y-1 w-full">
                        <p className="text-sm text-[#697386]">Item Specification</p>
                        <Input className="focus:border-none border-black"></Input>
                    </div>
                    <div className="flex flex-row w-full space-x-2">
                        <div className="space-y-1 w-full">
...
export default AddMaterialModal2