                ...
                <div className="flex flex-col justify-start mt-5 space-y-2">
                    <div className="flex flex-row w-full space-x-2">
                        <div className="space-y-1 w-3/4">
                            ...
                            <Input value={`${store?.name}`} disabled className="focus:border-none border-black"></Input>
                        </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <Input value={store?.cost_center_code} disabled className="focus:border-none border-black"></Input>
                    </div>
                </div>
