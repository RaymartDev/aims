...
interface ReceivedModalProps {
    ...
    handleReceive: (request: any, id: number) => Promise<void>;
}

function ReceivedModal({ open, onClose, release, handleReceive }: ReceivedModalProps) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-20 p-4">
            <div className="flex flex-col w-1/2 2xl:w-1/4 bg-slate-50 rounded-2xl p-6">
                <div className="flex items-center justify-between w-full border-b-2 border-black">
                    <h1 className="font-extrabold text-xl">Received By</h1>
